...
/* printBoard and loadNewPuzzle are the only functions you need to 
   implement.
  The values of the sudoku puzzle above should be displayed in the table 
  in index.html
...
var printBoard = function () {
    for (var row = 0; row < 9; row++) {
        for (var col = 0; col < 9; col++) {
            var loc = "r" + (row + 1) + (col + 1);
           // console.log("loc is " + loc);
            var td = document.getElementById(loc);
            td.innerHTML = "" + sol[row][col];
        }
    }
